...
var main = mongoose.connect('mongodb://'+process.env.USER+':'+process.env.PW+'@ds011735.mlab.com:11735/ecommerce');
...
new CronJob('00 00 * * *', function() {
  main.connection.db.dropCollection('rsvps', function(err, result) {
    if(err) throw err;
